...
namespace ProAgil.Repository
{
    public class ProAgilRepository : IProAgilRepository
    {
        ...
        public ProAgilRepository(ProAgilContext context)//contexto será injetado
        {
            _context = context;
        ...
        public async Task<Palestrante[]> GetAllPalestrantesAsyncByName(string name, bool includeEventos)
        {
            ...
            query = query.AsNoTracking().OrderBy(p => p.Nome).Where(p => p.Nome.Contains(name));
